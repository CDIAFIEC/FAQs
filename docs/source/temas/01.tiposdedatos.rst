...
En la :ref:`implementacion_clase_carro` se definen los atributos y los métodos de la Clase Carro en Java. Además, un ejemplo de una instancia y el uso de los métodos para acelerar y frenar. 
