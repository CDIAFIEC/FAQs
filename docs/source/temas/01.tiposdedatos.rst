...
.. rst-class:: do 
    ...
    Implemente el TDA Carro con la clase `Carro.java`, de acuerdo con las características del Paradigma de Programación Orientada a Objetos. Además, la instación de un objeto de la clase Carro y la prueba de sus métodos en el método `main`.
