...
2. Implemente un TDA `Clase` que contenga las propiedades `nombre`, `codigo` y `numeroEstudiantes`. Defina métodos para agregar estudiantes, eliminar estudiantes y mostrar la lista de estudiantes inscritos en la clase.
