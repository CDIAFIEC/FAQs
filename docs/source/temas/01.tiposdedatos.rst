...
Los tipos de datos primitivos son los bloques básicos de construcción en la programación. Representan valores simples y no se pueden descomponer en partes más pequeñas. En Java, los tipos primitivos incluyen enteros, reales, caracteres y booleanos. Ver la :ref:`tabla_tipos_datos_primitivos_java` para más detalles.
...
Los tipos de datos compuestos son estructuras más complejas que se construyen a partir de tipos primitivos. Permiten almacenar múltiples valores y definir comportamientos asociados. En Java, los tipos compuestos incluyen arreglos, clases y colecciones. Ver la :ref:`tabla_tipos_datos_compuestos_java` para más detalles.
...
.. note::
    ...
    Es más importante el **¿Qué hace?** en lugar de **¿Cómo lo hace?**.

En el contexto de los tipos de datos abstractos (TDA), la abstracción se utiliza para definir estructuras de datos y operaciones sin preocuparse por cómo se implementan internamente.
