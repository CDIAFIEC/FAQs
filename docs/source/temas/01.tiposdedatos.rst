...
Los tipos de datos primitivos son los bloques básicos de construcción en la programación. Representan valores simples y no se pueden descomponer en partes más pequeñas. En la :ref:`tabla_tipos_datos_primitivos_java` se presentan más detalles.
...
Los tipos de datos compuestos son estructuras más complejas que se construyen a partir de tipos primitivos. Permiten almacenar múltiples valores y definir comportamientos asociados. En la :ref:`tabla_tipos_datos_compuestos_java` se presentan más detalles.
...
.. rst-class:: do 
    ...
    Implemente el TDA Carro con la clase `Carro.java`, de acuerdo con las características del :doc:`Paradigma de Programación Orientada a Objetos <../transversales/01.POO>`. Además, instancie de un objeto de la clase Carro y compruebe de sus métodos en el método `main`.
