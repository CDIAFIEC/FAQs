...
En :ref:`implementacion_clase_carro` se muestra una implementación de la clase `Carro` en Java, que representa un TDA Carro. Esta clase define las propiedades y comportamientos del TDA Carro, permitiendo crear instancias de carros y realizar operaciones sobre ellos.:

.. _implementacion_clase_carro:

.. code-block:: java
    :caption: Implementación de la clase Carro en Java
