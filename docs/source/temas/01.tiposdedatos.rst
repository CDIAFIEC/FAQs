...
- **Primitivos**: Son los tipos de datos básicos que representan valores simples. Incluyen enteros, reales, lógicos y caracteres.
- **Compuestos**: Son aquellos que se construyen a partir de tipos primitivos y pueden contener múltiples valores. Incluyen arreglos, clases y colecciones( listas, conjuntos y mapas).
