...
Implemente el TDA Carro en Java, definiendo sus atributos y métodos. Asegúrese de que la implementación respete los principios del TDA, es decir, que separe las operaciones del estado interno del carro.

Ver :ref:`_tda_carro_java` la implementación de la clase Carro en Java.
