...
Revise la siguiente implementación de la clase Carro en Java.
...
3. Implemente un TDA `Profesor` que contenga las propiedades `nombre`, `especialidad` y `listaCursos`. Defina métodos para agregar cursos, eliminar cursos y mostrar la lista de cursos que imparte el profesor.
