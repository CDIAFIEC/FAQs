...
Una lista es una estructura de datos que permite almacenar y organizar un conjunto de elementos de manera secuencial, como se muestra en la imagen con la :ref:`composición de una lista <composicion_de_una_lista>`. Las listas son fundamentales ya que facilitan el manejo de colecciones de datos, permitiendo realizar operaciones como inserción, eliminación y búsqueda de elementos.
