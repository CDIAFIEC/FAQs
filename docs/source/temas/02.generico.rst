...
.. rst-class:: centered
    ...
    Diseña un el TDA **Caja fuerte** permita guardar un articulo.
...
A continuación, en la :ref:`CajaFuerte.java <solucion_caja_fuerte>` se muestra cómo se podría implementar el TDA Caja fuerte utilizando tipos genéricos en Java, mediante el uso de parámetros de tipo **<T>**:
...
.. code-block:: java
    ...
    public class Main {
        public static void main(String[] args) {
            ...
            CajaFuerte<Joyas> cajaFuerte3 = new CajaFuerte<Joyas>(new Joyas("Anillo de diamantes"));
